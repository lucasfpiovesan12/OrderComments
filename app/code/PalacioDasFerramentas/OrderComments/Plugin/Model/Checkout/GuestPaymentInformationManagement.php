<?php
namespace PalacioDasFerramentas\OrderComments\Plugin\Model\Checkout;

/**
 * Class GuestPaymentInformationManagement
 * @package PalacioDasFerramentas\OrderComments\Plugin\Model\Checkout
 */
class GuestPaymentInformationManagement
{
    /**
    ...
    public function beforeSavePaymentInformation(
        ...
        if ($commentsExtensionAttributes->getComments()):
            ...
            $quote->setPalacioOrderComments($orderComments);
        endif;
    }
}
